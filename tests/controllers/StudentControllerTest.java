...
public class StudentControllerTest {
    ...
    public void testFindByName(){
        ...
        Student s1=new Student(1,"firt1","last1","mail1",11);
        students.add(s1);
        Student s2=new Student(2,"firt2","last2","mail2",22);
        students.add(s2);
        Student s3=new Student(3,"firt3","last3","mail3",33);
        students.add(s3);
        Student s4=new Student(4,"firt4","last4","mail4",44);
        students.add(s4);
